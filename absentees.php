...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Quiz Beta | Absentees</title>
...
$conn_user = mysqli_connect($servername_user, $username_user, $password_user, $dbname_user);
      echo "<table align='center' id='tblexportData' class='text-center table table-bordered' style='width:85%;'>";
       $sql="SELECT * FROM users WHERE booleanvalue=0 and Batch>0 ORDER BY Batch;";
...
<script type="text/javascript">
  var date = new Date();
  var fname = "Absentees" + "_" + date.getDate() + "_"+ (date.getMonth()+1);
    $(function () {
